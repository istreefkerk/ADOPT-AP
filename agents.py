...
from polygene.library import neighbors
...
#------------------------------------------------
    def __init__(self, model, agents): #, model, agents) 
        AgentBaseClass.__init__(self, model, agents) #, model, agents
    ...
    def _initiate_locations(self):
        ...
        self.grid = self.width * self.height #this information can be found in input data of DRYP
    ...
    def _initiate_socio_hydrology(self):
        ...
        plt.imshow(self.abstraction_p.reshape(45,92))
        plt.show()
...
#----------------------------------------------------
    ...
    def Drought_SPEI(self):
        ...
        drought = np.where(self.spei<= -1.0, 1, 0)
...
#------------------------------------------------
    ...
    def load_timestep_data(self):
        ...
        self.spei = self.model.data.spei.sample_coords(self.lonlat, self.model.current_time) #self.model.rf.PET[0] same as rain in test version #RETURN WHEN WORKING EWASO
